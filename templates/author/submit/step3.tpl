...
<h4 style="color: #666; font-size: 1.2em">{translate key="author.submissions.step3_fillboth"}</h4>
<table width="100%" class="data">

<tr valign="top">
	<td width="20%" class="label">{fieldLabel name="title" required="true" key="article.title"}</td>
	<td width="80%" class="value"><input type="text" class="textField" name="title[pt_BR]" id="title" value="{$title.pt_BR}" size="60" maxlength="255" /></td>
</tr>
...
<tr valign="top">
	...
	<td width="80%" class="value"><textarea name="abstract[pt_BR]" id="abstract" class="textArea" rows="15" cols="60">{$abstract.pt_BR}</textarea></td>
</tr>
</table>
</div>

{// en_US}
<div id="titleAndAbstractEnUS">
<h3>{translate key="submission.titleAndAbstract"} (em inglês)</h3>

<table width="100%" class="data">

<tr valign="top">
	<td width="20%" class="label">{fieldLabel name="title" required="true" key="article.title"} (em inglês)</td>
	<td width="80%" class="value"><input type="text" class="textField" name="title[en_US]" id="title[en_US]" value="{$title.en_US}" size="60" maxlength="255" /></td>
</tr>

<tr valign="top">
  <td width="20%" class="label">{if $section->getAbstractsNotRequired()==0}{fieldLabel name="abstract" key="article.abstract" required="true"}{else}{fieldLabel name="abstract" key="article.abstract"}{/if} (em inglês)</td>
	<td width="80%" class="value"><textarea name="abstract[en_US]" id="abstract[en_US]" class="textArea" rows="15" cols="60">{$abstract.en_US}</textarea></td>
</tr>
</table>
</div>
...
<div id="indexing">
	...
	<tr valign="top">
		<td{if $currentJournal->getLocalizedSetting('metaSubjectExamples') != ''} rowspan="2"{/if} width="30%" class="label">{fieldLabel name="subject" key="article.subject"}</td>
		<td width="70%" class="value"><input type="text" class="textField" name="subject[pt_BR]" id="subject" value="{$subject.pt_BR}" size="60" maxlength="255" /></td>
	</tr>

	<tr valign="top">
		<td{if $currentJournal->getLocalizedSetting('metaSubjectExamples') != ''} rowspan="2"{/if} width="30%" class="label">{fieldLabel name="subject" key="article.subject"} (em inglês)</td>
		<td width="70%" class="value"><input type="text" class="textField" name="subject[en_US]" id="subject" value="{$subject.en_US}" size="60" maxlength="255" /></td>
	</tr>
