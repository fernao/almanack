...
<div id="periodicos">
<h3>{translate key="plugins.generic.periodicos"}</h3>
<ul class="plain">
<li>
» <a href="{url page="periodicos" op="listarPeriodicos" path="nome"}">listar periódicos</a> [<a href="{url page="periodicos" op="createPeriodico"}">incluir novo periodico</a>]
</li>
</ul>
</div>
<div class="separator">&nbsp;</div>
