...
<table width="100%" class="data">
	<tr>
		...
		<td width="80%" class="value"><input type="text" name="title[pt_BR]" id="title" value="{$title.pt_BR}" size="60" maxlength="255" class="textField" /></td>
	</tr>
	...
	<tr valign="top">
		...
		<td class="value"><textarea name="abstract[pt_BR]" id="abstract" rows="15" cols="60" class="textArea">{$abstract.pt_BR}</textarea></td>
	</tr>
</table>
</div>
...
<table width="100%" class="data">
	<tr>
		...
		<td width="80%" class="value"><input type="text" name="title[en_US]" id="title[en_US]" value="{$title.en_US}" size="60" maxlength="255" class="textField" /></td>
	</tr>
	...
	<tr valign="top">
		<td class="label">{if $section->getAbstractsNotRequired()==0}{fieldLabel name="abstract" required="true" key="article.abstract"}{else}{fieldLabel name="abstract" key="article.abstract"}{/if} (em inglês)</td>
		<td class="value"><textarea name="abstract[en_US]" id="abstract[en_US]" rows="15" cols="60" class="textArea">{$abstract.en_US}</textarea></td>
	</tr>
</table>
</div>
...
<table width="100%" class="data">
	...
	<tr valign="top">
		...
		<td class="value">
			<input type="text" name="subject[{$formLocale|escape}]" id="subject" value="{$subject.pt_BR}" size="40" maxlength="255" class="textField" />
		</td>
	</tr>

	<tr valign="top">
		<td class="label">{fieldLabel name="subject" key="article.subject"} (em inglês)</td>
		<td class="value">
			<input type="text" name="subject[en_US]" id="subject" value="{$subject.en_US}" size="40" maxlength="255" class="textField" />
