	...
	function manage($verb, $args, &$message) {
		...
		switch ($verb) {
			case 'enable':
				...
				$message = Localex::translate('common.pluginEnabled', array('pluginName' => $this->getDisplayName()));
				return false;

			case 'disable':
				$this->setEnabled(false);
				$message = Localex::translate('common.pluginDisabled', array('pluginName' => $this->getDisplayName()));
				return false;
		}
