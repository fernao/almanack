...
class ListbuilderHandler extends GridHandler {
	...
	function fetch(&$args, &$request, $additionalVars = null) {
		...
		$okButton = Localex::translate('common.ok');
		$warning = Localex::translate('common.warning');
	...
	function setupTemplate() {
		...
		Localex::requireComponents(array(LOCALE_COMPONENT_APPLICATION_COMMON, LOCALE_COMPONENT_OMP_MANAGER, LOCALE_COMPONENT_PKP_MANAGER));
	}
}
