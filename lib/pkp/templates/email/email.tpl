...
{php}
// almanack
// para pagina de envio de emails para conselho


$para = $_POST['to'];

if ($para == 'almanack_braziliense@yahoogrupos.com.br') {
  $body = $_POST['reviewFormResponses'][1];
  $parecer = $_POST['parecer'];
  $subject = $_POST['subject'];
  $body = "PARECER: " . $parecer . "\n\n" . $body;

  $to = array(array('name' => 'Conselho da Revista Almanack',
                    'email' => $para));
