				...
				case 5:
					if ($request->getUserVar('uploadHomeHeaderTitleImage')) {
						if ($setupForm->uploadImage('homeHeaderTitleImage', $formLocale)) {
							...
							$setupForm->addError('homeHeaderTitleImage', Localex::translate('manager.setup.homeTitleImageInvalid'));
						}
						...
						if ($setupForm->uploadImage('homeHeaderLogoImage', $formLocale)) {
							...
							$setupForm->addError('homeHeaderLogoImage', Localex::translate('manager.setup.homeHeaderImageInvalid'));
						}
						...
						if ($setupForm->uploadImage('journalFavicon', $formLocale)) {
							...
							$setupForm->addError('journalFavicon', Localex::translate('manager.setup.journalFaviconInvalid'));
						}
						...
						if ($setupForm->uploadImage('pageHeaderTitleImage', $formLocale)) {
							...
							$setupForm->addError('pageHeaderTitleImage', Localex::translate('manager.setup.pageHeaderTitleImageInvalid'));
						}
						...
						if ($setupForm->uploadImage('pageHeaderLogoImage', $formLocale)) {
							...
							$setupForm->addError('pageHeaderLogoImage', Localex::translate('manager.setup.pageHeaderLogoImageInvalid'));
						}
						...
						if ($setupForm->uploadImage('homepageImage', $formLocale)) {
							...
							$setupForm->addError('homepageImage', Localex::translate('manager.setup.homepageImageInvalid'));
						}
						...
						if ($setupForm->uploadStyleSheet('journalStyleSheet')) {
							...
							$setupForm->addError('journalStyleSheet', Localex::translate('manager.setup.journalStyleSheetInvalid'));
						}
