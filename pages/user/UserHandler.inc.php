...
class UserHandler extends Handler {
	...
	function setLocale($args) {
		...
		if (Localex::isLocaleValid($setLocale) && (!isset($journalSupportedLocales) || in_array($setLocale, $journalSupportedLocales)) && in_array($setLocale, $site->getSupportedLocales())) {
	...
	function authorizationDenied($args, &$request) {
		...
		$this->setupTemplate(true);
		Localex::requireComponents(array(LOCALE_COMPONENT_PKP_USER));
		$templateMgr =& TemplateManager::getManager();
	...
	function setupTemplate($subclass = false) {
		...
		Localex::requireComponents(array(LOCALE_COMPONENT_OJS_AUTHOR, LOCALE_COMPONENT_OJS_EDITOR, LOCALE_COMPONENT_OJS_MANAGER));
		$templateMgr =& TemplateManager::getManager();
		if ($subclass) {
