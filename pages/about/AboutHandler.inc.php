...
class AboutHandler extends Handler {
	...
	function index() {
		...
		if ($journalPath != 'index' && $journalDao->journalExistsByPath($journalPath)) {
			...
			if (isset($customAboutItems[Localex::getLocale()])) $templateMgr->assign('customAboutItems', $customAboutItems[Localex::getLocale()]);
			elseif (isset($customAboutItems[Localex::getPrimaryLocale()])) $templateMgr->assign('customAboutItems', $customAboutItems[Localex::getPrimaryLocale()]);
	...
	function setupTemplate($subclass = false) {
		...
		Localex::requireComponents(array(LOCALE_COMPONENT_OJS_MANAGER, LOCALE_COMPONENT_PKP_MANAGER));
	...
	function aboutThisPublishingSystem() {
		...
		foreach (array(Localex::getLocale(), $primaryLocale = Localex::getPrimaryLocale(), 'en_US') as $locale) {
