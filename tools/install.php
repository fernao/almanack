...
class OJSInstallTool extends InstallTool {
	 ...
	 */
	function readParams() {
		Localex::requireComponents(array(LOCALE_COMPONENT_PKP_INSTALLER, LOCALE_COMPONENT_APPLICATION_COMMON, LOCALE_COMPONENT_PKP_USER));
		printf("%s\n", Localex::translate('installer.ojsInstallation'));
