...
class ResolverPlugin extends GatewayPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.gateways.resolver.displayName');
	}

	function getDescription() {
		return Localex::translate('plugins.gateways.resolver.description');
	}
	...
	function getManagementVerbs() {
		...
		if (Validation::isSiteAdmin() && $this->getEnabled()) {
			$verbs[] = array(
				'exportHoldings',
				Localex::translate('plugins.gateways.resolver.exportHoldings')
			);
		}
		return $verbs;
	}
