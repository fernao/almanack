...
class METSGatewayPlugin extends GatewayPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.gateways.metsGateway.displayName');
	}

	function getDescription() {
		return Localex::translate('plugins.gateways.metsGateway.description');
	}
	...
	function getManagementVerbs() {
		...
		$verbs[] = array(
			'settings', Localex::translate('plugins.gateways.metsGateway.settings')
		);
		return $verbs;
	}
