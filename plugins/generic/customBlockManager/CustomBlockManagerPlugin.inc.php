...
class CustomBlockManagerPlugin extends GenericPlugin {
	function getDisplayName() {
		return Localex::translate('plugins.generic.customBlockManager.displayName');
	}

	function getDescription() {
		return Localex::translate('plugins.generic.customBlockManager.description');
	}
	...
	function getManagementVerbs() {
		$verbs = array();
		if ($this->getEnabled()) {
			$verbs[] = array('settings', Localex::translate('plugins.generic.customBlockManager.settings'));
		}
			...
			case 'settings':
				...
				$pageCrumbs = array(
					...
					array(
						...
						Localex::translate('manager.plugins'),
						true
					)
				);
