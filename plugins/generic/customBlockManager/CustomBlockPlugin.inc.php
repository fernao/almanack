...
class CustomBlockPlugin extends BlockPlugin {
	...
	function getManagementVerbs() {
		...
		if ($this->getEnabled()) {
			...
			$verbs[] = array(
				'edit',
				Localex::translate('plugins.generic.customBlock.edit')
			);
		} else {
			$verbs[] = array(
				'enable',
	...
	function getDisplayName() {
		return $this->blockName . ' ' . Localex::translate('plugins.generic.customBlock.nameSuffix');
	}
	...
	function getDescription() {
		return Localex::translate('plugins.generic.customBlock.description');
	}
}
