...
class ThesisForm extends Form {
	...
	function ThesisForm($parentPluginName, $thesisId = null) {
		...
		$this->validStatus = array (
			THESIS_STATUS_INACTIVE => Localex::translate('plugins.generic.thesis.manager.status.inactive'),
			THESIS_STATUS_ACTIVE => Localex::translate('plugins.generic.thesis.manager.status.active')
		);

		$this->validDegrees = array (
			THESIS_DEGREE_MASTERS => Localex::translate('plugins.generic.thesis.manager.degree.masters'),
			THESIS_DEGREE_DOCTORATE => Localex::translate('plugins.generic.thesis.manager.degree.doctorate')
		);
