...
class ThesisSettingsForm extends Form {
	...
	function ThesisSettingsForm(&$plugin, $journalId) {
		...
		$this->validOrder = array (
			THESIS_ORDER_SUBMISSION_DATE_ASC => Localex::translate('plugins.generic.thesis.settings.order.submissionDateAsc'),
			THESIS_ORDER_SUBMISSION_DATE_DESC => Localex::translate('plugins.generic.thesis.settings.order.submissionDateDesc'),
			THESIS_ORDER_APPROVAL_DATE_ASC => Localex::translate('plugins.generic.thesis.settings.order.approvalDateAsc'),
			THESIS_ORDER_APPROVAL_DATE_DESC => Localex::translate('plugins.generic.thesis.settings.order.approvalDateDesc'),
			THESIS_ORDER_LASTNAME_ASC => Localex::translate('plugins.generic.thesis.settings.order.lastNameAsc'),
			THESIS_ORDER_LASTNAME_DESC => Localex::translate('plugins.generic.thesis.settings.order.lastNameDesc'),
			THESIS_ORDER_TITLE_ASC => Localex::translate('plugins.generic.thesis.settings.order.titleAsc'),
			THESIS_ORDER_TITLE_DESC => Localex::translate('plugins.generic.thesis.settings.order.titleDesc')
		);
