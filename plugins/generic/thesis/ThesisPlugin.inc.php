...
class ThesisPlugin extends GenericPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.generic.thesis.displayName');
	}

	function getDescription() {
		return Localex::translate('plugins.generic.thesis.description');
	}
	...
	function getManagementVerbs() {
		$verbs = array();
		if ($this->getEnabled()) {
			$verbs[] = array('theses', Localex::translate('plugins.generic.thesis.manager.theses'));
			$verbs[] = array('settings', Localex::translate('plugins.generic.thesis.manager.settings'));
		}
	...
	function manage($verb, $args, &$message) {
		...
		Localex::requireComponents(array(LOCALE_COMPONENT_APPLICATION_COMMON,  LOCALE_COMPONENT_PKP_MANAGER, LOCALE_COMPONENT_PKP_USER));
		$templateMgr =& TemplateManager::getManager();
