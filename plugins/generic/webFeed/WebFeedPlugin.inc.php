...
class WebFeedPlugin extends GenericPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.generic.webfeed.displayName');
	}
	...
	function getDescription() {
		return Localex::translate('plugins.generic.webfeed.description');
	}
	...
	function getManagementVerbs() {
		$verbs = array();
		if ($this->getEnabled()) {
			$verbs[] = array('settings', Localex::translate('plugins.generic.webfeed.settings'));
		}
