...
class StaticPagesPlugin extends GenericPlugin {
	function getDisplayName() {
		return Localex::translate('plugins.generic.staticPages.displayName');
	}

	function getDescription() {
		$description = Localex::translate('plugins.generic.staticPages.description');
		if ( !$this->isTinyMCEInstalled() )
			$description .= "<br />".Localex::translate('plugins.generic.staticPages.requirement.tinymce');
		return $description;
	}
	...
	function getManagementVerbs() {
		...
		if ($this->getEnabled()) {
			if ($this->isTinyMCEInstalled()) {
				$verbs[] = array('settings', Localex::translate('plugins.generic.staticPages.editAddContent'));
			}
		}
