...
class OpenAIREPlugin extends GenericPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.generic.openAIRE.displayName');
	}

	function getDescription() {
		return Localex::translate('plugins.generic.openAIRE.description');
	}	
	...
	function changeXML($hookName, $params) {
		...
		$types = array_merge_recursive(
			empty($types)?array(Localex::getLocale() => Localex::translate('rt.metadata.pkp.peerReviewed')):$types,
		...
		if ($openAIREDao->isOpenAIREArticle($article->getArticleId())) {
			...
			$rights = array_merge_recursive(
				empty($rights)?array(Localex::getLocale() => $openAIRERights):
