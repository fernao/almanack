...
class TranslatorPlugin extends GenericPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.generic.translator.name');
	}

	function getDescription() {
		return Localex::translate('plugins.generic.translator.description');
	}
	...
	function getManagementVerbs() {
		$verbs = array();
		if ($this->getEnabled()) {
			$verbs[] = array('translate', Localex::translate('plugins.generic.translator.translate'));
		}
