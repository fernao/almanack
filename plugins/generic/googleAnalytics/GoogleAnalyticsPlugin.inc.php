...
class GoogleAnalyticsPlugin extends GenericPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.generic.googleAnalytics.displayName');
	}

	function getDescription() {
		return Localex::translate('plugins.generic.googleAnalytics.description');
	}
	...
	function getManagementVerbs() {
		$verbs = array();
		if ($this->getEnabled()) {
			$verbs[] = array('settings', Localex::translate('plugins.generic.googleAnalytics.manager.settings'));
		}
