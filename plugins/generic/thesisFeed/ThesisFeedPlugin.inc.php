...
class ThesisFeedPlugin extends GenericPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.generic.thesisfeed.displayName');
	}
	...
	function getDescription() {
		return Localex::translate('plugins.generic.thesisfeed.description');
	}
	...
	function getManagementVerbs() {
		$verbs = array();
		if ($this->getEnabled()) {
			$verbs[] = array('settings', Localex::translate('plugins.generic.thesisfeed.settings'));
		}
