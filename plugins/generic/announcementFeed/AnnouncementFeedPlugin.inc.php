...
class AnnouncementFeedPlugin extends GenericPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.generic.announcementfeed.displayName');
	}
	...
	function getDescription() {
		return Localex::translate('plugins.generic.announcementfeed.description');
	}
	...
	function getManagementVerbs() {
		$verbs = array();
		if ($this->getEnabled()) {
			$verbs[] = array('settings', Localex::translate('plugins.generic.announcementfeed.settings'));
		}
