...
class QuickSubmitPlugin extends ImportExportPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.importexport.quickSubmit.displayName');
	}

	function getDescription() {
		return Localex::translate('plugins.importexport.quickSubmit.description');
	}

	function display(&$args) {
		$templateMgr =& TemplateManager::getManager();
		$templateMgr->register_function('plugin_url', array(&$this, 'smartyPluginUrl'));
		Localex::requireComponents(array(LOCALE_COMPONENT_OJS_AUTHOR, LOCALE_COMPONENT_OJS_EDITOR, LOCALE_COMPONENT_PKP_SUBMISSION));
		$this->setBreadcrumbs();
