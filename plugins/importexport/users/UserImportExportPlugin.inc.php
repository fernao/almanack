...
class UserImportExportPlugin extends ImportExportPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.importexport.users.displayName');
	}

	function getDescription() {
		return Localex::translate('plugins.importexport.users.description');
	}
	...
	function executeCLI($scriptName, &$args) {
		...
		if (!$journal) {
			if ($journalPath != '') {
				echo Localex::translate('plugins.importexport.users.import.errorsOccurred') . ":\n";
				echo Localex::translate('plugins.importexport.users.unknownJournal', array('journalPath' => $journalPath)) . "\n\n";
			}
		...
		switch ($command) {
			case 'import':
				...
				// Success.
				echo Localex::translate('plugins.importexport.users.import.usersWereImported') . ":\n";
			...
			case 'export':
				...
				if (($h = fopen($xmlFile, 'wb'))===false) {
					echo Localex::translate('plugins.importexport.users.export.errorsOccurred') . ":\n";
					echo Localex::translate('plugins.importexport.users.export.couldNotWriteFile', array('fileName' => $xmlFile)) . "\n";
					return false;
				}
	...
	function usage($scriptName) {
		echo Localex::translate('plugins.importexport.users.cliUsage', array(
