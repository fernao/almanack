...
class NativeExportDom {
	...
	function &generateSuppFileDom(&$doc, &$journal, &$issue, &$article, &$suppFile) {
		...
		switch ($suppFile->getType()) {
			case Localex::translate('author.submit.suppFile.researchInstrument'):
				$suppFileType = 'research_instrument';
				break;
			case Localex::translate('author.submit.suppFile.researchMaterials'):
				$suppFileType = 'research_materials';
				break;
			case Localex::translate('author.submit.suppFile.researchResults'):
				$suppFileType = 'research_results';
				break;
			case Localex::translate('author.submit.suppFile.transcripts'):
				$suppFileType = 'transcripts';
				break;
			case Localex::translate('author.submit.suppFile.dataAnalysis'):
				$suppFileType = 'data_analysis';
				break;
			case Localex::translate('author.submit.suppFile.dataSet'):
				$suppFileType = 'data_set';
				break;
			case Localex::translate('author.submit.suppFile.sourceText'):
