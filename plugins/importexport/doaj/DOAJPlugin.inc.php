...
class DOAJPlugin extends ImportExportPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.importexport.doaj.displayName');
	}
	...
	function getDescription() {
		return Localex::translate('plugins.importexport.doaj.description');
	}
