...
class KeywordCloudBlockPlugin extends BlockPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.block.keywordCloud.displayName');
	}
	...
	function getDescription() {
		return Localex::translate('plugins.block.keywordCloud.description');
	}
	...
	function getContents(&$templateMgr) {
		...
		$cache =& $cacheManager->getFileCache('keywords_' . Localex::getLocale(), $journal->getId(), array(&$this, '_cacheMiss'));
