...
class CustomThemePlugin extends ThemePlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.theme.custom.name');
	}

	function getDescription() {
		return Localex::translate('plugins.theme.custom.description');
	}
	...
	function getManagementVerbs() {
		return array(array('settings', Localex::translate('plugins.theme.custom.settings')));
	}
