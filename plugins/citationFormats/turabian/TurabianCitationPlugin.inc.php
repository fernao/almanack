...
class TurabianCitationPlugin extends CitationPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.citationFormats.turabian.displayName');
	}

	function getCitationFormatName() {
		return Localex::translate('plugins.citationFormats.turabian.citationFormatName');
	}

	function getDescription() {
		return Localex::translate('plugins.citationFormats.turabian.description');
	}
