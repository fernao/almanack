...
class ProCiteCitationPlugin extends CitationPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.citationFormats.proCite.displayName');
	}

	function getCitationFormatName() {
		return Localex::translate('plugins.citationFormats.proCite.citationFormatName');
	}

	function getDescription() {
		return Localex::translate('plugins.citationFormats.proCite.description');
	}
