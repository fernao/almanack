...
class AbntCitationPlugin extends CitationPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.citationFormats.abnt.displayName');
	}

	function getCitationFormatName() {
		return Localex::translate('plugins.citationFormats.abnt.citationFormatName');
	}

	function getDescription() {
		return Localex::translate('plugins.citationFormats.abnt.description');
	}
