...
class RefManCitationPlugin extends CitationPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.citationFormats.refMan.displayName');
	}

	function getCitationFormatName() {
		return Localex::translate('plugins.citationFormats.refMan.citationFormatName');
	}

	function getDescription() {
		return Localex::translate('plugins.citationFormats.refMan.description');
	}
