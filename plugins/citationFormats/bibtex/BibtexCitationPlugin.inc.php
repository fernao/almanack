...
class BibtexCitationPlugin extends CitationPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.citationFormats.bibtex.displayName');
	}

	function getCitationFormatName() {
		return Localex::translate('plugins.citationFormats.bibtex.citationFormatName');
	}

	function getDescription() {
		return Localex::translate('plugins.citationFormats.bibtex.description');
	}
