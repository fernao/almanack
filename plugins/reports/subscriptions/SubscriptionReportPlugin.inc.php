...
class SubscriptionReportPlugin extends ReportPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.reports.subscriptions.displayName');
	}
	...
	function getDescription() {
		return Localex::translate('plugins.reports.subscriptions.description');
	}
	...
	function display(&$args) {
		...
		$columns = array(Localex::translate('subscriptionManager.individualSubscriptions'));
		String::fputcsv($fp, array_values($columns));

		$columnsCommon = array(
			'subscription_id' => Localex::translate('common.id'),
			'status' => Localex::translate('subscriptions.status'),
			'type' => Localex::translate('common.type'),
			'format' => Localex::translate('subscriptionTypes.format'),
			'date_start' => Localex::translate('manager.subscriptions.dateStart'),
			'date_end' => Localex::translate('manager.subscriptions.dateEnd'),
			'membership' => Localex::translate('manager.subscriptions.membership'),
			'reference_number' => Localex::translate('manager.subscriptions.referenceNumber'),
			'notes' => Localex::translate('common.notes')
		);

		$columnsIndividual = array(
			'name' => Localex::translate('user.name'),
			'mailing_address' => Localex::translate('common.mailingAddress'),
			'country' => Localex::translate('common.country'),
			'email' => Localex::translate('user.email'),
			'phone' => Localex::translate('user.phone'),
			'fax' => Localex::translate('user.fax')
		);
			...
			foreach ($columns as $index => $junk) {
				switch ($index) {
					...
					case 'type':
						...
						break;
					case 'format':
						$columns[$index] = Localex::translate($subscriptionType->getFormatString());
						break;
					case 'date_start':
		...
		$columns = array(Localex::translate('subscriptionManager.institutionalSubscriptions'));
		String::fputcsv($fp, array_values($columns));

		$columnsInstitution = array(
			'institution_name' => Localex::translate('manager.subscriptions.institutionName'),
			'institution_mailing_address' => Localex::translate('plugins.reports.subscriptions.institutionMailingAddress'),
			'domain' => Localex::translate('manager.subscriptions.domain'),
			'ip_ranges' => Localex::translate('plugins.reports.subscriptions.ipRanges'),
			'contact' => Localex::translate('manager.subscriptions.contact'),
			'mailing_address' => Localex::translate('common.mailingAddress'),
			'country' => Localex::translate('common.country'),
			'email' => Localex::translate('user.email'),
			'phone' => Localex::translate('user.phone'),
