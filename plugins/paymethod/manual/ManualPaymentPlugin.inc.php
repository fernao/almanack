...
class ManualPaymentPlugin extends PaymethodPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.paymethod.manual.displayName');
	}

	function getDescription() {
		return Localex::translate('plugins.paymethod.manual.description');
	}
		...
		switch ( $op ) {
			case 'notify':
				...
				$mail->assignParams(array(
					...
					'userFullName' => $user?$user->getFullName():('(' . Localex::translate('common.none') . ')'),
					'userName' => $user?$user->getUsername():('(' . Localex::translate('common.none') . ')'),
