...
class PayPalPlugin extends PaymethodPlugin {
	...
	function getDisplayName() {
		return Localex::translate('plugins.paymethod.paypal.displayName');
	}
	...
	function getDescription() {
		return Localex::translate('plugins.paymethod.paypal.description');
	}   
	...
	function displayPaymentForm($queuedPaymentId, &$queuedPayment) {
		...
		$params = array(
			...
			'lc' => String::substr(Localex::getLocale(), 3), 
