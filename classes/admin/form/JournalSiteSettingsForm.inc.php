...
class JournalSiteSettingsForm extends Form {
	...
	function execute() {
		...
		if ($journal->getId() != null) {
			...
			Localex::requireComponents(array(LOCALE_COMPONENT_OJS_DEFAULT, LOCALE_COMPONENT_APPLICATION_COMMON));
			...
			$section->setTitle(Localex::translate('section.default.title'), $journal->getPrimaryLocale());
			$section->setAbbrev(Localex::translate('section.default.abbrev'), $journal->getPrimaryLocale());
			$section->setMetaIndexed(true);
			$section->setMetaReviewed(true);
			$section->setPolicy(Localex::translate('section.default.policy'), $journal->getPrimaryLocale());
