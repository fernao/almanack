...
class SubscriptionTypeForm extends Form {
	...
	function SubscriptionTypeForm($typeId = null) {
		...
		$this->validFormats = array (
			SUBSCRIPTION_TYPE_FORMAT_ONLINE => Localex::translate('subscriptionTypes.format.online'),
			SUBSCRIPTION_TYPE_FORMAT_PRINT => Localex::translate('subscriptionTypes.format.print'),
			SUBSCRIPTION_TYPE_FORMAT_PRINT_ONLINE => Localex::translate('subscriptionTypes.format.printOnline')
		);
