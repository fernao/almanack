...
class IssueAction {
	...
	function getIssueOptions() {
		...
		$issueOptions['-100'] =  '------    ' . Localex::translate('editor.issues.futureIssues') . '    ------';
		...
		$issueOptions['-101'] = '------    ' . Localex::translate('editor.issues.currentIssue') . '    ------';
		...
		$issueOptions['-102'] = '------    ' . Localex::translate('editor.issues.backIssues') . '    ------';
