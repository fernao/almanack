...
class AuthorSubmitStep3Form extends AuthorSubmitForm {
	...
	function AuthorSubmitStep3Form(&$article, &$journal) {
		...
		//		$this->addCheck(new FormValidatorLocale($this, 'abstract', 'required', 'author.submit.form.abstractRequired')); // adicionei abstract
		//		$this->addCheck(new FormValidatorLocale($this, 'title[en_US]', 'required', 'author.submit.form.titleRequired'));
		$this->addCheck(new FormValidatorLocale($this, 'abstract', 'required', 'author.submit.form.abstractRequired', 'en_US')); //
		//		$this->addCheck(new FormValidatorLocale($this, 'abstract_en', 'required', 'author.submit.form.abstractRequired', 'en_US')); // adicionei abstract en_US
	...
	function initData() {
		...
		if (isset($this->article)) {
			...
			$this->_data = array(
				...
				'title_en' => $article->getTitle(null), // Localized
