...
class AuthorSubmitStep1Form extends AuthorSubmitForm {
	...
	function display() {
		...
		$templateMgr->assign('sectionOptions', array('0' => Localex::translate('author.submit.selectSection')) + $sectionDao->getSectionTitles($journal->getId(), !$isEditor));
	...
	function initData() {
		if (isset($this->article)) {
			...
			$tryLocales = array(
				...
				Localex::getLocale(), // Current UI locale
