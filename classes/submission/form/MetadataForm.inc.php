...
class MetadataForm extends Form {
		...
		if ($this->canEdit) {
			...
			parent::Form(
				...
				array_flip(array_intersect(
					array_flip(Localex::getAllLocales()),
	...
	function display() {
		...
		Localex::requireComponents(array(LOCALE_COMPONENT_OJS_EDITOR)); // editor.cover.xxx locale keys; FIXME?
		...
		if ($this->isEditor) {
			...
			$hideAuthorOptions = array(
				AUTHOR_TOC_DEFAULT => Localex::Translate('editor.article.hideTocAuthorDefault'),
				AUTHOR_TOC_HIDE => Localex::Translate('editor.article.hideTocAuthorHide'),
				AUTHOR_TOC_SHOW => Localex::Translate('editor.article.hideTocAuthorShow')
			);
