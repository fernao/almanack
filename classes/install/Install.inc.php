...
class Install extends PKPInstall {
	...
	function createData() {
		if ($this->getParam('manualInstall')) {
			...
			$this->executeSQL(sprintf('INSERT INTO site_settings (setting_name, setting_type, setting_value, locale) VALUES (\'%s\', \'%s\', \'%s\', \'%s\')', 'title', 'string', addslashes(Localex::translate(INSTALLER_DEFAULT_SITE_TITLE)), $this->getParam('locale')));
			$this->executeSQL(sprintf('INSERT INTO site_settings (setting_name, setting_type, setting_value, locale) VALUES (\'%s\', \'%s\', \'%s\', \'%s\')', 'contactName', 'string', addslashes(Localex::translate(INSTALLER_DEFAULT_SITE_TITLE)), $this->getParam('locale')));
			...
			$siteSettingsDao->updateSetting('title', array($locale => Localex::translate(INSTALLER_DEFAULT_SITE_TITLE)), null, true);
			$siteSettingsDao->updateSetting('contactName', array($locale => Localex::translate(INSTALLER_DEFAULT_SITE_TITLE)), null, true);
