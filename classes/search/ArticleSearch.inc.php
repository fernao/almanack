...
class ArticleSearch {
	...
	function _parseQuery($signTokens, $tokens, &$pos, $total) {
		...
		$notOperator = String::strtolower(Localex::translate('search.operator.not'));
		$andOperator = String::strtolower(Localex::translate('search.operator.and'));
		$orOperator = String::strtolower(Localex::translate('search.operator.or'));
		while ($pos < $total) {
